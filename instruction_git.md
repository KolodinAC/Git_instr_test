...
### Работа с чужим репозитоием и выполнение Pull request

Чтобы поработать на чужим опен сорс проектом необходимо:
...
3. После доработки и внесения изменений отправить данные в GitHub командой **push**
4. Далее через функцию "**Pull request**" отправить свой вариант доработок на рассмотрение владельцу оригинального репозитория, который может их принять и влить в свой основной билд.